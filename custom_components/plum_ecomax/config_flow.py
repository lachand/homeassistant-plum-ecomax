...
class OptionsFlowHandler(config_entries.OptionsFlow):
    ...
    async def async_step_entity_type(self, _=None) -> FlowResult:
    ...
    async def async_step_add_sensor(self, _=None) -> FlowResult:
        """Handle adding a new sensor."""
        self.platform = Platform.SENSOR
        return await self.async_step_entity_details()

    async def async_step_add_binary_sensor(self, _=None) -> FlowResult:
        """Handle adding a new binary sensor."""
        self.platform = Platform.BINARY_SENSOR
        return await self.async_step_entity_details()

    async def async_step_add_number(self, _=None) -> FlowResult:
        """Handle adding a new number."""
        self.platform = Platform.NUMBER
        return await self.async_step_entity_details()

    async def async_step_add_switch(self, _=None) -> FlowResult:
    ...
    async def async_step_reload(self, _=None) -> FlowResult:
        """Handle reloading config."""
        self.hass.async_create_task(async_reload_config(self.hass, self.config_entry))
